...
func TestInt2BoolMapper(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := int2boolMapper(from, toV, nil)
			if err != nil {
...
func TestInt2IntMapper(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := int2intMapper(fromVal, toVal, nil)
			if err != nil {
...
func TestInt2UintMapper(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			gotErr := int2uintMapper(from, to, nil)
...
func TestInt2floatMapper(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := int2floatMapper(from, to, nil)
			if err != nil {
...
func TestInt2stringMapper(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := int2stringMapper(tc.from, to, nil)
			if err != nil {
				t.Fatalf("Unexpected error: %v", err)
			}
